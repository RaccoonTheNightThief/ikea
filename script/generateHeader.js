const generateHeader = () => {
    ...
    document.body.insertAdjacentHTML('afterbegin', headerHTML); //вставить что и куда
}

export default generateHeader; //default для того, чтобы при приемке файла, не писать в фигурный скобках что необходимо принять, так как по дефолту уже отправляется функция